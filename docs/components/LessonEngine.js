import { renderMultipleChoice, destroyMultipleChoice } from './exercises/MultipleChoice.js?v=200.0';
import { renderSentenceBuilder, destroySentenceBuilder } from './exercises/SentenceBuilder.js?v=200.0';
import { renderListeningExercise, destroyListeningExercise } from './exercises/ListeningExercise.js?v=200.0';
import { renderMatchingPairs, destroyMatchingPairs } from './exercises/MatchingPairs.js?v=200.0';
import { renderFlashcardMode, destroyFlashcardMode } from './exercises/FlashcardMode.js?v=200.0';
import { renderIrregularVerbs, destroyIrregularVerbs } from './exercises/IrregularVerbs.js?v=200.0';

import AudioService from '../services/audioService.js?v=200.0';
import StorageService from '../services/storageService.js?v=200.0';
import { WORDS, IRREGULAR_VERBS, LESSONS } from '../services/initialData.js?v=200.0';
