...
function renderAppLayout(onTabChange = () => {}, onUserAuthChanged = () => {}, onLogoClick = () => {}) {
  ...
  app.innerHTML = `
    <div class="mobile-app ${currentTheme === 'dark' ? 'dark-theme' : ''}">
      ...
      <svg class="notebook-ink-blot" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        <path fill="#581c87" d="M50,22 C55,13 60,11 63,16 C66,21 62,26 65,30 C70,27 76,21 80,26 C84,31 77,36 76,40 C82,41 90,45 91,52 C92,59 83,60 79,62 C84,68 88,76 82,81 C76,86 71,79 67,75 C64,81 61,90 54,91 C47,92 47,82 43,76 C39,83 32,90 26,86 C20,81 25,72 28,66 C22,68 12,70 10,63 C7,56 16,52 21,48 C16,45 8,39 12,32 C16,25 24,31 30,35 C28,29 26,18 33,15 C40,12 43,24 50,22 Z M71,12 C73.2,12 75,10.2 75,8 C75,5.8 73.2,4 71,4 C68.8,4 67,5.8 67,8 C67,10.2 68.8,12 71,12 Z M87,21 C89,21 90.5,19.5 90.5,17.5 C90.5,15.5 89,14 87,14 C85,14 83.5,15.5 83.5,17.5 C83.5,19.5 85,21 87,21 Z M26,18 C28,18 29.5,16.5 29.5,14.5 C29.5,12.5 28,11 26,11 C24,11 22.5,12.5 22.5,14.5 C22.5,16.5 24,18 26,18 Z M19,77 C21,77 22.5,75.5 22.5,73.5 C22.5,71.5 21,70 19,70 C17,70 15.5,71.5 15.5,73.5 C15.5,75.5 17,77 19,77 Z M72,90 C74,90 75.5,88.5 75.5,86.5 C75.5,84.5 74,83 72,83 C70,83 68.5,84.5 68.5,86.5 C68.5,88.5 70,90 72,90 Z M75,97 C76.2,97 77.2,96 77.2,94.8 C77.2,93.6 76.2,92.6 75,92.6 C73.8,92.6 72.8,93.6 72.8,94.8 C72.8,96 73.8,97 75,97 Z"/>
      </svg>
