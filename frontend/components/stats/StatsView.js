import { getUserStats, toggleFavoriteApi, getUserFavorites, isWordMastered, getUserProgress } from '../../services/api.js?v=200.0';
import { getCurrentUser } from '../../services/authService.js?v=200.0';
